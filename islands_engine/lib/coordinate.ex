defmodule IslandsEngine.Coordinate do
  ...
  move around
  """
  @spec set_in_island(pid(), atom()) :: :ok
  ...
  @doc """
  Function to return a description of what inside coordiante
  """
  @spec to_string(pid()) :: charlist()
